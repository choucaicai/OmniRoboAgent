...
- [x] `DONE` 按通用框架使用路径重组用户文档，并拆分 Agent Core 与其他 framework components；Docsify 全局 sidebar 使用 route-root links，避免 `relativePath` 在嵌套路由中重复拼接路径（[计划](plans/0011-user-doc-information-architecture.md)）。
